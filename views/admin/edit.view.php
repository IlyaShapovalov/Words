<div class="flex crud-wraper">  
    ...
    <form class="crud-form crud-form-an" action="" method="post">
        ...
        <input type="text" class="crud-form-input crud-form-term bg-light fs-500 letter-spacing-3" autocomplete="off" name="edited-term" id="edited-term" value="<?= e($view_bag['term']) ?>"/>
        <textarea class="crud-form-input crud-form-def bg-light fs-500 letter-spacing-3" name="edited-description" id="edited-description" cols="20" rows="5"><?= e($view_bag['def']) ?></textarea>
